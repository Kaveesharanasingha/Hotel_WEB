				...
				<form action="#" method="post" class="tm-contact-form">
					...
					<div class="col-lg-6 col-md-6 tm-contact-form-input">
						<div class="form-group">
                                                    <input type="text" name="uname" id="username" class="form-control" placeholder="Enter your name" />
						</div>
						<div class="form-group">
							<input type="email" name="uemail" id="useremail" class="form-control" placeholder="Enter your email" />
						</div>
                        <div>
                            <input type="text" id="useraddress" name="useradd" class="form-control" placeholder="Enter your address" >
						</div>
						<br>
						<div>
                                                    <input type="tel" name="unumber" id="userphone" class="form-control" placeholder="Enter your form number">
						</div>
						<br>
						<div>
							
								<label for="nights"> how many nights do you want to stay?</label>
