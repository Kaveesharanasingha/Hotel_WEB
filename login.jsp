		  ...
		  <ul class="slides">
		    <li>
			    <div class="tm-banner-inner">
					<h1 class="tm-banner-title">REGISTER <span class="tm-yellow-text">WITH</span> US</h1>
		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">SIGN IN</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>				
			</div>
			<div class="row">
				...
				<form action="#" method="post" class="tm-contact-form">
					...
					<div class="col-lg-6 col-md-6 tm-contact-form-input">
						<div class="form-group">
							<input type="text" id="contact_name" class="form-control" placeholder="USER NAME" />
						</div>
						
						<div class="form-group">
							<input type="text" id="contact_subject" class="form-control" placeholder="PASSWORD" />
						</div>
						<div class="form-group">
							<textarea id="contact_message" class="form-control" rows="6" placeholder="COMMENT"></textarea>
						</div>
						<div class="form-group">
							<button class="tm-submit-btn" type="submit" name="submit">SIGN IN</button> 
						</div>               
					</div>
				</form>
			</div>			
