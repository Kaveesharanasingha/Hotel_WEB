<%-- 
    Document   : index
    Created on : Sep 19, 2020, 2:45:52 PM
    Author     : Himaya Chmodi
--%>
		  ...
		  <ul class="slides">
		    ...
		    <li>
			    <div class="tm-banner-inner">
					...
					<p class="tm-banner-subtitle">wonderful destination</p>
					<a href="#more" class="tm-banner-link">Learn More</a>	
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="tm-section-header section-margin-top">
					...
					<div class="col-lg-4 col-md-6 col-sm-6"><h2 class="tm-section-title">Honeymoon room Packages</h2></div>
					<div class="col-lg-4 col-md-3 col-sm-3"><hr></div>	
				</div>
				<div class="col-lg-6">
					<div class="tm-home-box-3">
						<div class="tm-home-box-3-img-container">
							<img src="img/h1.jpg" alt="image" class="img-responsive">	
						</div>						
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Romantic Honeymoon</p>
					        <div class="tm-home-box-2-container">
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<a href="#" class="tm-home-box-2-link"><span class="tm-home-box-2-description box-3">Book now</span></a>
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-edit tm-home-box-2-icon border-left"></i></a>
						</div>
						</div>						
					</div>					
			     ...
			     <div class="col-lg-6">
			        <div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Candle night Honeymoon</p>
					        <div class="tm-home-box-2-container">
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<a href="#" class="tm-home-box-2-link"><span class="tm-home-box-2-description box-3">Book now</span></a>
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-edit tm-home-box-2-icon border-left"></i></a>
				...
				<div class="col-lg-6">
				    <div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Rose petal bath</p>
					        <div class="tm-home-box-2-container">
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<a href="#" class="tm-home-box-2-link"><span class="tm-home-box-2-description box-3">Book now</span></a>
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-edit tm-home-box-2-icon border-left"></i></a>
			    ...
			    <div class="col-lg-6">
			        <div class="tm-home-box-3">
						...
						<div class="tm-home-box-3-info">
							<p class="tm-home-box-3-description">Luxuary Honeymoon</p>
					        <div class="tm-home-box-2-container">
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-heart tm-home-box-2-icon border-right"></i></a>
							<a href="#" class="tm-home-box-2-link"><span class="tm-home-box-2-description box-3">Book now</span></a>
							<a href="#" class="tm-home-box-2-link"><i class="fa fa-edit tm-home-box-2-icon border-left"></i></a>
